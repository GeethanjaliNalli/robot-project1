...
TC_02 Verify Navigation In The About Section
    [Documentation]    Verifies that a user can navigate through all tabs in the About section after login.
    ...    Ensures each tab is accessible and the About dialog can be closed successfully.
